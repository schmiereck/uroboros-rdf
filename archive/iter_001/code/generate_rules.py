...
filter trivial ones, and write results to iter_001/results/ and iter_001/result.yaml.
"""
import itertools
import json
import os
...
def main():
    ...
    summary = {
        ...
        "artifacts": [
            "archive/iter_001/code/generate_rules.py",
            "archive/iter_001/results/valid_rules.json",
        ],
        "metrics": {
            "total_bit_conserving_permutations": total,
            "trivial_rules_found": trivial_found,
        ...
        "notes": "Permutations within each Hamming-weight group; 3 trivial rules excluded.",
        "log_excerpt": "",
    }
    ...
    print(f"Trivial rules filtered: {trivial_found}")
    print(f"Non-trivial rules found: {nontrivial_found}")
